                            ...
                            <div class="bundle-main">
                                <ul class="item-content clearfix">
                                    <div class="pay-phone">
                                        <li class="td td-item">
                                            <div class="item-pic">
                                                <a href="/goodsdetail?id={{$val->goods_id}}" class="J_MakePoint">
                                                    <img src="{{$val->photo}}"
                                                         class="itempic J_ItemImg"></a>
                                            </div>
                                            <div class="item-info">
                                                <div class="item-basic-info">
                                                    <a href="/goodsdetail?id={{$val->goods_id}}" class="item-title J_MakePoint"
                                                       data-point="tbcart.8.11">{{$val->name}}</a>
                                                </div>
                                            </div>
                                        </li>
                                        <li class="td td-info">
                                            <div class="item-props">
                                                <span class="sku-line">口味：{{$val->taste}}</span>
                                            </div>
                                        </li>
                                    ...
                                    <li class="td td-sum">
                                        <div class="td-inner">
                                            <em tabindex="0"
                                                class="J_ItemSum number"><?=sprintf("%.2f", $val->price * $val->num)?></em>
                                        </div>
                                    </li>
